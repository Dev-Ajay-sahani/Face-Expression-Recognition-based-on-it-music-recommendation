...
def main(Emotion,folder_path):
    root = tk.Tk()
    root.title(Emotion+" Song's Music Player")
    root.geometry("500x400")
    root.configure(background="white")
    root.iconbitmap("assets/adgips.ico")
...
def scan():
    ...
    face_exp_model.load_weights('assets/facial_expression_model_weights.h5')
...
img = Image.open("assets/bg.png").resize((1150,800))
